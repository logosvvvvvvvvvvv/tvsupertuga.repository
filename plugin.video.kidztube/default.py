...
YOUTUBE_CHANNEL_ID_12 = "stampylonghead"
...
def main_list(params):
    ...
    plugintools.add_item( 
        #action="", 
        title="Stampy (minecraft)",
        url="plugin://plugin.video.youtube/user/"+YOUTUBE_CHANNEL_ID_12+"/",
        thumbnail="https://yt3.ggpht.com/-bY_OkstVA0g/AAAAAAAAAAI/AAAAAAAAAAA/x2CqwQ35Dco/s240-c-k-no/photo.jpg",
        folder=True )
run()
