...
base='http://houseofdroids.download/hodupdates/tools/'
ADDON=xbmcaddon.Addon(id='plugin.video.hodwizard')
dialog = xbmcgui.Dialog()    
VERSION = "2.0.2"
PATH = "House Of Droids Wizard"            

    
def CATEGORIES():
    link = OPEN_URL('http://houseofdroids.download/hodupdates/tools/wizard/wizard.txt').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dp.create("House Of Droids Wizard","Downloading ",'', 'Please Wait')
