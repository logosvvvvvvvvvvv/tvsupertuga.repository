...
addon_id = 'plugin.video.arbupdater'
ADDON = xbmcaddon.Addon(id=addon_id)
AddonID='plugin.video.arbupdater'
AddonTitle="ARB UPDATER"
...
PATH = "Kobra Wizard"            
BASEURL = "https://archive.org/download/andrewrb84_gmail_AIO"
BASEURL1 = "https://archive.org/download/andrewrb84_gmail_AIOU/"
BASEURL2 = "https://archive.org/download/AIOGUI/"
BASEURL3 = "https://archive.org/download/andrewrb84_gmail_AIOS"
BASEURL4 = "https://archive.org/download/AIOSU/"
BASEURL5 = "https://archive.org/download/AIOSGUI/"
BASEURL6 = "https://archive.org/download/arbfirestick/"
BASEURL7 = "https://archive.org/download/arbfirestick/"
H = 'http://'
EXCLUDES     = ['plugin.video.kobrawizard','script.module.addon.common','repository.arb','plugin.video.kobrawizardssleeve','plugin.video.kobraapkdownloader','plugin.video.arbupdater']

def INDEX():
    addDir('ARB INSTALL',BASEURL,2,ART+'install.png',FANART,'')
    addDir('ARB MAINTENANCE',BASEURL,3,ART+'maintenance.png',FANART,'')
    addDir('ARB CONTACT',BASEURL,8,ART+'facebook.png',FANART,'')
    setView('movies', 'MAIN')

def BUILDMENU():
    addDir('ALL IN ONE BUILD',BASEURL+'/AIO.zip',5,ART+'aio1.jpg',FANART,'')
    setView('movies', 'MAIN')
    addDir('ALL IN ONE UPDATE',BASEURL1+'/AIOU.zip',5,ART+'aio2.jpg',FANART,'')
    setView('movies', 'MAIN')
    addDir('ALL IN ONE GUIFIX',BASEURL2+'/AIOGUI.zip',5,ART+'aio3.jpg',FANART,'')
    setView('movies', 'MAIN')
    addDir('AIO SIMPLE',BASEURL3+'/AIOS.zip',5,ART+'aios1.jpg',FANART,'')
    setView('movies', 'MAIN')
    addDir('AIO SIMPLE UPDATE',BASEURL4+'/AIOSU.zip',5,ART+'aios2.jpg',FANART,'')
    setView('movies', 'MAIN')
    addDir('AIO SIMPLE GUIFIX',BASEURL5+'/AIOSGUI.zip',5,ART+'aios3.jpg',FANART,'')
    setView('movies', 'MAIN')
    addDir('FIRE STICK BUILD',BASEURL6+'/arbfirestick.zip',5,ART+'fs1.jpg',FANART,'')
    setView('movies', 'MAIN')
    addDir('FIRE STICK BUILD GUIFIX',BASEURL7+'/arbfirestickg.zip',5,ART+'fs2.jpg',FANART,'')
    setView('movies', 'MAIN')
...
def facebook():
    TextBoxes('ARB Updater', '[COLOR=steelblue]Welcome to ARB Builds. Facebook page https://fb.com/groups/758088277692140/?fth=1 Or follow me on Twitter @ARBBuilds[/COLOR]')
...
def WIZARD(name,url,description):
    ...
    dp.create("ARB Updater","Downloading your build ",'', 'Please Wait')
    ...
    dialog = xbmcgui.Dialog()
    dialog.ok("ARB Updater", "To save changes you now need to force close Kodi, Press OK to force close Kodi")
    killxbmc()
        ...
        # Count files and give option to delete
            if file_count > 0:
                ...
                if dialog.yesno("Delete Package Cache Files", str(file_count) + " files found", "Do you want to delete them?"):
                    ...
                    dialog = xbmcgui.Dialog()
                    dialog.ok("ARB Updater", "Packages Successfuly Removed", "[COLOR steelblue]Brought To You By ARB[/COLOR]")
    except: 
        dialog = xbmcgui.Dialog()
        dialog.ok("ARB Updater", "Sorry we were not able to remove Package Files", "[COLOR steelblue]Brought To You By ARB[/COLOR]")
